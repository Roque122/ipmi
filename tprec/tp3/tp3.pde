...
void draw() {
  ...
  float colorFondo = map(distancia, 0, 800, 150, 220); 
  ...
  for (int i = 0; i < 2; i++) {
    for (int j = 0; j < 2; j++) {
      if (i == 0 && j == 0) dibujarBloqueB(400, 0, tam, rotar2, col1, col2);
      if (i == 1 && j == 0) dibujarBloqueN(400, 0, tam, rotar1, col1, col2);
      if (i == 0 && j == 1) dibujarBloqueB(400, 0, tam, rotar4, col1, col2);
      if (i == 1 && j == 1) dibujarBloqueN(400, 0, tam, rotar3, col1, col2);
    }
  }
}
